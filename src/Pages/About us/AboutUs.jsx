    ...
    <div className={style.container}>
      ...
      <div className={` ${style.containerFluid} container-fluid d-flex justify-content-center align-items-center`}>
        ...
        <section className={`d-inline ${style.mainHomeText}`}>
          <div className={`${style.welcomeBarNew}`}>
            <div className={`${style.textOrange}`}>من نحن</div>
          ...
          <div>
            <h1 className={style.mainHeading1}>
              مهمتنا هي <span className={style.highlight}> الإعلام والإلهام</span>
            </h1>

            <p className={`${style.subText} mt-4`}>
              مدونة متخصصة في فن التصوير الفوتوغرافي، نشارك معكم أسرار المحترفين ونصائح عملية<br /> لتطوير مهاراتكم. نحن شغوفون بمشاركة المعرفة ومساعدة المصورين على تنمية مهاراتهم من<br /> خلال محتوى عالي الجودة.            </p>

          </div>

          <div className="d-flex flex-wrap justify-content-center " >
            <div className={`${style.statBox}  mt-5 me-3 p-3 text-center`}>
              <h2 className={style.statNumber}>+15</h2>
              <p className={style.statLabel}>تصنيف</p>
            </div>
            <div className={`${style.statBox}  mt-5 me-3 p-3 text-center`}>
              <h2 className={style.statNumber}>+50</h2>
              <p className={style.statLabel}>كاتب خبير</p>
            </div>
            <div className={`${style.statBox}  mt-5 me-3 p-3 text-center`}>
              <h2 className={style.statNumber}>+500</h2>
              <p className={style.statLabel}>مقالة منشورة</p>
            </div>
            <div className={`${style.statBox}  mt-5 me-3 p-3 text-center`}>
              <h2 className={style.statNumber} dir='rtl'>+2مليون</h2>
              <p className={style.statLabel}>قارئ شهرياً</p>
            </div>
          </div>
        </section>
      </div>
      ...
      <div className={style.valuesContainer}>
        <section className={style.valuesSection}>
          <div className={style.valuesHeader}>
            <div className={style.barOrange}></div>
            <h2 className={style.valuesMainTitle}>قيمنا</h2>
            <div className={style.barOrange}></div>
          </div>

          <p className={style.valuesSubtitle}>المبادئ التي توجه كل ما تقوم بأشنائنا</p>

          <div className={style.valuesGrid}>
            <div className={`${style.valueCard}`}>
              <div className={style.valueIcon}>↻</div>
              <h3 className={style.valueTitle}>دائماً محدث</h3>
              <p className={style.valueDescription}>أحدث التشاحات وأفضل الممارسات</p>
            </div>

            <div className={`${style.valueCard}`}>
              <div className={style.valueIcon}>👥</div>
              <h3 className={style.valueTitle}>المجتمع</h3>
              <p className={style.valueDescription}>تعليم مع ألف المصورين</p>
            </div>

            <div className={`${style.valueCard}`}>
              <div className={style.valueIcon}>⚡</div>
              <h3 className={style.valueTitle}>تركيز عملي</h3>
              <p className={style.valueDescription}>اجمة وافية بممكنك تطبيقها اليوم</p>
            </div>

            <div className={`${style.valueCard}`}>
              <div className={style.valueIcon}>◎</div>
              <h3 className={style.valueTitle}>الجودة أولاً</h3>
              <p className={style.valueDescription}>محتوى مدروس ومكتوب بخبرة</p>
            </div>
          </div>
        </section>
      </div>
      ...
      <div className={style.team}>
        <div className={`${style.welcomeBar2} `}>
          <div className={`${style.textOrange}`}>فريقنا</div>
          <div className={`${style.circle1} rounded-circle`}></div>
        </div>

        <div className={`${style.title}`}>
          <h2 className={style.mainHeading}>تعرف على فريقنا</h2>
          <p className={style.subText}>
            . فريقنا من المصورين والكتاب ذوي الخبرة شغوفون بمشاركة معرفتهم مع المجتمع</p>
          ...
          <div className="container">
            <div className="row" dir='rtl'>
              {authers.map((auther) => {
                return (
                  <div className="col-6 col-md-4 mb-4" key={auther.id} >
                    <div className={style.authorCard}>
                      <img src={auther.author.avatar} alt={auther.author.name} className={style.authorImage} />
                      <h3 className={style.authorName}>{auther.author.name}</h3>
                      <p className={style.authorRole}>{auther.author.role}</p>


                      <div className={style.socialIcons}>
                        <a href="#" className={style.socialIcon} aria-label="LinkedIn">
                          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4.98 3.5C4.98 4.88 3.88 6 2.5 6C1.12 6 0 4.88 0 3.5C0 2.12 1.12 1 2.5 1C3.88 1 4.98 2.12 4.98 3.5ZM0.5 8H4.5V23H0.5V8ZM8.5 8H12.1V10.2H12.2C12.9 9 14.7 7.8 17 7.8C21.5 7.8 22 10.6 22 14.2V23H18V14.9C18 12.9 17.9 10.4 14.6 10.4C11.2 10.4 10.8 12.8 10.8 14.7V23H6.8V8H8.5Z" fill="#fff" />
                          </svg>
                        </a>

                        <a href="#" className={style.socialIcon} aria-label="GitHub">
                          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 .5C5.73.5.75 5.48.75 11.75c0 4.9 3.17 9.06 7.57 10.53.55.1.75-.24.75-.53 0-.26-.01-1.12-.02-2.03-3.08.67-3.73-1.49-3.73-1.49-.5-1.27-1.22-1.61-1.22-1.61-.99-.68.08-.67.08-.67 1.1.08 1.68 1.13 1.68 1.13.97 1.66 2.54 1.18 3.16.9.1-.7.38-1.18.69-1.45-2.46-.28-5.05-1.23-5.05-5.47 0-1.21.43-2.2 1.13-2.98-.12-.28-.49-1.42.11-2.96 0 0 .92-.29 3.02 1.13A10.5 10.5 0 0112 6.8c.93.004 1.87.125 2.75.37 2.1-1.42 3.02-1.13 3.02-1.13.6 1.54.23 2.68.11 2.96.7.78 1.13 1.77 1.13 2.98 0 4.25-2.6 5.18-5.07 5.46.39.34.74 1.02.74 2.06 0 1.49-.01 2.69-.01 3.06 0 .29.19.64.76.53C19.08 20.8 22.25 16.64 22.25 11.75 22.25 5.48 17.27.5 12 .5z" fill="#fff" />
                          </svg>
                        </a>

                        <a href="#" className={style.socialIcon} aria-label="X">
                          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5 3L19 21M19 3L5 21" stroke="#fff" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                          </svg>
                        </a>
                      </div>
                    </div>
